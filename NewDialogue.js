...
window.dialogue_brownBear=function(player,items,NPCs){
    ...
    return function(diff){
        ...
        return ["Welcome! Ready for one of my repeatable quests? You've completed "+diff+' quests.',"I'll give honey and rewards for every quest, but special prizes at certain milestones!","Obtain a Bear Bee egg at 25 quests!","Check your quest menu to see what you need.",
